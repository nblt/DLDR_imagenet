...
do
CUDA_VISIBLE_DEVICES=0,1,2  python3 main.py -a $model --epochs 90  --dist-url 'tcp://127.0.0.1:8888' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0 /home/pami/Datasets/ILSVRC2012
